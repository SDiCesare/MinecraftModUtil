...
public class IniFile {
    ...
    public static class IniProperty {
        ...
        public String getValue(String name) {
            return this.values.get(this.indexOfName(name));
        }
        ...
        public void removeValue(int index) {
            for (int i = index; i < this.values.size() - 1; i++) {
                String s = this.values.get(i);
                String s1 = this.values.get(i + 1);
                this.values.set(i, s1);
                this.values.set(i + 1, s);
            }
